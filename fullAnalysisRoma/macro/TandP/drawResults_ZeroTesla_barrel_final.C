...
const double ptBinCentersEB[nPtBinsEB]   = {25., 35., 45., 55.,70., 95., 130.,175.,235.,385.};   
const double ptBinHalfWidthEB[nPtBinsEB] = { 5.,  5., 5.,5.,10.,15.,20.,25.,35.,115.};
...
void drawResults(){
  ...
  data_eff_file.open("TP_files/data_eff_barrel_final.txt");
  double eff=0;
  double eff_err=0;
  ...
  mc_eff_file.open("TP_files/mc_eff_barrel_final.txt");
  eff=0;
  eff_err=0;
...
//    fname = cname;
//    fname += "_EE.pdf";
//    std::cout<<"EE is not saved"<<std::endl;
    //c1->Print(fname);
