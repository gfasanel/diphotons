...
const int nPtBinsEB =5;   
const double ptBinLimitsEB[nPtBinsEB+1]  = {25., 35., 45., 60., 100., 500.};
const double ptBinCentersEB[nPtBinsEB]   = {30., 40., 52.5, 80., 300.};   
const double ptBinHalfWidthEB[nPtBinsEB] = { 5.,  5.,  7.5, 20, 200};  
const TString etaLimitsStringArrayEB[nEtaBins] = { "0. < |#eta| < 1.4442" };
...
void drawResults(){
  ...
  for(int ieta = 0; ieta<nEtaBins; ieta++){
    ...
    TString cname = "~/scratch1/www/TP/76/sfEff_";
