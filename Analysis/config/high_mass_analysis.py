...
variables=["mass","pt","rapidity","eta",
           ...
           "mass_5x5 := mass*sqrt(leadingPhoton.full5x5_e5x5*subLeadingPhoton.full5x5_e5x5/(leadingPhoton.energyAtStep('initial')*subLeadingPhoton.energyAtStep('initial')))",
...
histograms=["mass>>mass(1500,0,15000)",
            ...
            "mass_5x5>>lowmass_5x5(560,60,200)",
